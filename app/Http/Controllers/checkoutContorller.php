...
class checkoutContorller extends Controller
{
    ...
    public function momo_payment(Request $request)
    {
        ...
        $amount = $request->total_qr_momo;
        $orderId = time() ."";
        // $redirectUrl = "http://127.0.0.1:8000/interior-index";
        // $ipnUrl = "http://127.0.0.1:8000/interior-index";
        $redirectUrl = "http://127.0.0.1:8000/interior-checkout";
        $ipnUrl = "http://127.0.0.1:8000/interior-checkout";
        $extraData = "";
        ...
        // if (!empty($_POST)) {
            ...
            $requestId = time() . "";
            $requestType = "captureWallet"; //dùng để phân biệt phương thức thanh toán
    ...
    public function vnpay_payment(Request $request)
    {
        ...
        // $vnp_Returnurl = "http://127.0.0.1:8000/interior-checkout";
        ...
        $vnp_OrderInfo = 'Test Thanh toán qua VNPAY';
