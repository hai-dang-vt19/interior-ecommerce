...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <div class="cart-table-area section-padding-100" style="background-color: rgb(255, 255, 255)">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="cart-title mt-50 ">
                            <h2 class="border-bottom border-warning">Shopping Cart</h2>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="cart_product_desc">
                                            <h5>{{$cart->name_product}} - {{$cart->id_product}}</h5>
                                        </td>
                                        <td class="price">
                                            <span>{{number_format($cart->price_product)}} &#8363;</span>
                                        </td>
                                        <td class="qty">
                                            {{$cart->amount_product}}
                                        </td>
