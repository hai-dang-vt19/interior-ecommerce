...
>
    <div class="bod">
        {{-- <div class="row">
            <div class="col-12">
                <div class="card bg-dark border-0 text-white text-center">
                    <img class="card-img" src="{{ asset('interior\assets\img\elements\11.jpg') }}" alt="Card image" />
                    <div class="card-img-overlay">
                      <h5 class="card-title">Chung Si Interior <br>
                        <p class="mt-2" style="color: #fff; font-size: 13px; font-style: italic">Cảm ơn bạn đã sử dụng sản phẩm của tôi</p>
                      </h5>
                      
                      <p class="card-text">
                        {{ $data['title'] }} <i class='bx bxs-heart bx-tada' ></i>
                      </p>
                      <p class="card" style="color: #FFC800;">
                        {{ $data['name'] }}
                      </p>
                      <p class="card-text">Sử dụng mã {{ $data['content'] }} khi mua hàng để giảm nhé</p>
                    </div>
                  </div>
            </div>
        </div> --}}
