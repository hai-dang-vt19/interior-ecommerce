              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <hr class="my-0">
                    <div class="card-body">
                      <form action="{{ route('update_material', ['id'=>$material['id']]) }}" method="POST">
                        @csrf
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <select class="form-select" name="supplier">
                                <option value="{{$material['supplier']}}" selected>{{$material['supplier']}}</option>
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <select class="form-select" name="status_material">
                                <option selected value="{{$material['status_material']}}">{{$material['status_material']}}</option>
